!function() {
  ...
  d3_selectionPrototype.insert = function(name, before) {
    ...
    return this.select(function() {
      var a = this.insertBefore(name.apply(this, arguments), before.apply(this, arguments) || null);
      console.log(jQuery.extend({}, a));
      return a;
    });
  };
    ...
    function axis(g) {
      g.each(function() {
        ...
        var ticks = tickValues == null ? scale1.ticks ? scale1.ticks.apply(scale1, tickArguments_) : scale1.domain() : tickValues,
            ...
            tick1 = g.selectAll(".tick");
        var tick = tick1.data(ticks, scale1);
        var tickEnter = tick.enter().insert("g", ".domain").attr("class", "tick").style("opacity", ε);
        console.log(tickEnter, jQuery.extend({}, tickEnter))
